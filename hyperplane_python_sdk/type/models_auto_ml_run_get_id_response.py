...
class RequiredModelsAutoMLRunGetIdResponse(TypedDict):
...
class OptionalModelsAutoMLRunGetIdResponse(TypedDict, total=False):
...
class ModelsAutoMLRunGetIdResponse(RequiredModelsAutoMLRunGetIdResponse, OptionalModelsAutoMLRunGetIdResponse):
    pass
