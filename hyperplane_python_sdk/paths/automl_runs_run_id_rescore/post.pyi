...
class BaseApi(api_client.Api):
    ...
    def _rerun_inference_mapped_args(
        self,
        run_id: str,
    ...
    async def _arerun_inference_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/automl/runs/{run_id}/rescore',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RerunInferenceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arerun_inference(
        self,
        run_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._rerun_inference_mapped_args(
            run_id=run_id,
        )
        return await self._arerun_inference_oapg(
    ...
    def rerun_inference(
        ...
        return self._rerun_inference_oapg(
            path_params=args.path,
        )

class RerunInference(BaseApi):
    ...
    async def arerun_inference(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arerun_inference(
            run_id=run_id,
            **kwargs,
        )
        if validate:
    ...
    def rerun_inference(
        ...
        raw_response = self.raw.rerun_inference(
            run_id=run_id,
        )
        if validate:
            return ModelsAutoMLLookalikeCreateResponsePydantic(**raw_response.body)
