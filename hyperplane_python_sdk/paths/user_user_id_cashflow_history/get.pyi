...
from hyperplane_python_sdk.model.models_user_cashflow_history_response import ModelsUserCashflowHistoryResponse as ModelsUserCashflowHistoryResponseSchema

from hyperplane_python_sdk.type.models_user_cashflow_history_response import ModelsUserCashflowHistoryResponse

from ...api_client import Dictionary
from hyperplane_python_sdk.pydantic.models_user_cashflow_history_response import ModelsUserCashflowHistoryResponse as ModelsUserCashflowHistoryResponsePydantic

# Query params
StartDateSchema = schemas.StrSchema
EndDateSchema = schemas.StrSchema
AggregationSchema = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationJson = ModelsUserCashflowHistoryResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ModelsUserCashflowHistoryResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_user_cashflow_history_mapped_args(
        self,
        user_id: str,
        module_id: str,
        ...
        if aggregation is not None:
            _query_params["aggregation"] = aggregation
    ...
    async def _aget_user_cashflow_history_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/user/{user_id}/cashflow/history',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_user_cashflow_history_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GetUserCashflowHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_user_cashflow_history(
        self,
        user_id: str,
        module_id: str,
        start_date: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_user_cashflow_history_mapped_args(
            user_id=user_id,
            module_id=module_id,
        ...
        return await self._aget_user_cashflow_history_oapg(
    ...
    def get_user_cashflow_history(
        ...
        return self._get_user_cashflow_history_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class GetUserCashflowHistory(BaseApi):
    ...
    async def aget_user_cashflow_history(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ModelsUserCashflowHistoryResponsePydantic:
        raw_response = await self.raw.aget_user_cashflow_history(
            user_id=user_id,
            module_id=module_id,
            start_date=start_date,
            end_date=end_date,
        ...
        if validate:
            return ModelsUserCashflowHistoryResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ModelsUserCashflowHistoryResponsePydantic, raw_response.body)
    ...
    def get_user_cashflow_history(
        ...
        raw_response = self.raw.get_user_cashflow_history(
            user_id=user_id,
            module_id=module_id,
            start_date=start_date,
            end_date=end_date,
