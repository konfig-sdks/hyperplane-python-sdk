...
class BaseApi(api_client.Api):
    ...
    def _check_status_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acheck_status_oapg(
        self,
...
class CheckStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_status(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._check_status_mapped_args(
        )
        return await self._acheck_status_oapg(
            **kwargs,
        )
    ...
    def check_status(
        ...
        return self._check_status_oapg(
        )

class CheckStatus(BaseApi):
    ...
    async def acheck_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_status(
            **kwargs,
        )
        if validate:
    ...
    def check_status(
        ...
        raw_response = self.raw.check_status(
        )
        if validate:
            return RootModel[str](raw_response.body).root
        return raw_response.body
