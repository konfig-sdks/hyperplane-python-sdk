...
SchemaFor403ResponseBodyApplicationJson = ApiErrResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_definition_mapped_args(
        self,
        persona_id: str,
    ...
    async def _adelete_definition_oapg(
        self,
...
class DeleteDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_definition(
        self,
        persona_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_definition_mapped_args(
            persona_id=persona_id,
        )
        return await self._adelete_definition_oapg(
    ...
    def delete_definition(
        ...
        return self._delete_definition_oapg(
            path_params=args.path,
        )

class DeleteDefinition(BaseApi):
    ...
    async def adelete_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_definition(
            persona_id=persona_id,
            **kwargs,
        )
        if validate:
    ...
    def delete_definition(
        ...
        raw_response = self.raw.delete_definition(
            persona_id=persona_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
