...
class BaseApi(api_client.Api):
    ...
    def _get_run_status_mapped_args(
        self,
        run_id: str,
    ...
    async def _aget_run_status_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/automl/runs/{run_id}/status',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRunStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_run_status(
        self,
        run_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_run_status_mapped_args(
            run_id=run_id,
        )
        return await self._aget_run_status_oapg(
    ...
    def get_run_status(
        ...
        return self._get_run_status_oapg(
            path_params=args.path,
        )

class GetRunStatus(BaseApi):
    ...
    async def aget_run_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_run_status(
            run_id=run_id,
            **kwargs,
        )
        if validate:
    ...
    def get_run_status(
        ...
        raw_response = self.raw.get_run_status(
            run_id=run_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
