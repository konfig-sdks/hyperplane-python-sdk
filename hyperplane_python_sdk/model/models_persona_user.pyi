...
class ModelsPersonaUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "score", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "score", ], str]):
