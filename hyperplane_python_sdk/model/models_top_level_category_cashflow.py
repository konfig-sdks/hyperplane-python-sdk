...
class ModelsTopLevelCategoryCashflow(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class categories(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ModelsCategoryCashflow']:
                        return ModelsCategoryCashflow
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ModelsCategoryCashflow'], typing.List['ModelsCategoryCashflow']],
                ...
                def __getitem__(self, i: int) -> 'ModelsCategoryCashflow':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "categories", "name", "percentage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "categories", "name", "percentage", ], str]):
